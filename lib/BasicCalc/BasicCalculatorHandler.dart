...
void main() {
  print(BasicCalculatorHandler.evaluateExpression("sin(30) + cos(60) * (2 + 3)")); // ≈ 3.5
  print(BasicCalculatorHandler.evaluateExpression("2 + 3 * 4")); // = 14
  print(BasicCalculatorHandler.evaluateExpression("invalid")); // null
}
